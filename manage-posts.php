            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <!-- end row -->
<legend>Search Posts
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Posts.." title="Search for your post">
</legend>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
...
<table class="table table-colored table-centered table-inverse m-0" id="myTable">
<thead>
<tr>
